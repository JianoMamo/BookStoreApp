...
import com.example.android.bookstoreapp.BookStoreData.QueryHandler;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
            ...
            public void onClick(View v) {
                if (currentUri != null) {
                    ...
                    if (quantity > 0) {
                        ...
                        Toast.makeText(MainActivity.this, R.string.cannot_negativequant, Toast.LENGTH_LONG).show();
                    }
                } else {
                    if (quantity_it > 0) {
                        quantity_it--;
    ...
    private boolean insertBookEntry() {
        ...
        if (bookName.equals("")) {
            ...
            Toast.makeText(MainActivity.this,this.getString(R.string.error_nedname),Toast.LENGTH_LONG).show();
            return false;
        } else {
        ...
        if (supplierName.equals("")) {
            editTextSuppName.setError(getString(R.string.errorsupname));
            Toast.makeText(MainActivity.this,this.getString(R.string.errorsupname),Toast.LENGTH_LONG).show();
            return false;
        } else {
        ...
        if (supplierPhone.equals("")) {
            editTextSuppPhone.setError(getString(R.string.errorsupphone));
            Toast.makeText(MainActivity.this,this.getString(R.string.errorsupphone),Toast.LENGTH_LONG).show();
            ...
            if (isPhoneValid(supplierPhone)) {
                ...
                Toast.makeText(MainActivity.this,this.getString(R.string.invalphone),Toast.LENGTH_LONG).show();

                return false;
            }
        }

        QueryHandler handler = new QueryHandler(getContentResolver());
